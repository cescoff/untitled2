...
import fr.untitled2.common.entities.raspi.SimpleStringResponse;
 ...
 */
public class GetBatchTaskLogs extends Command<BatchTaskPayload, SimpleStringResponse, SimpleStringResponse> {

    @Override
    protected SimpleStringResponse execute(BatchTaskPayload input, User user, String fromIpAddress) throws Exception {
        ...
        SimpleStringResponse result = new SimpleStringResponse();
    ...
    @Override
    protected Class<SimpleStringResponse> getOutputObjectType() {
        return SimpleStringResponse.class;
    }
